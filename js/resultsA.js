...
if (searchTerm !== '') {
    ...
    onValue(agentsRef, (snapshot) => {
        ...
        agentsData.forEach((agent, index) => {
            if ((agent.a1?.toLowerCase() || '').includes(searchTerm.toLowerCase()) ||
                (agent.a2?.toLowerCase() || '').includes(searchTerm.toLowerCase()) ||
                (agent.a3?.toLowerCase() || '').includes(searchTerm.toLowerCase())) {
